# 🚀 Hướng dẫn Bắt đầu AegisFlow AI

> _"Từ lý thuyết sang thực hành — Triển khai AegisFlow AI ngay hôm nay"_
...
```bash
npm run migrate
npm run seed  # (nếu cần dữ liệu mẫu ngập lụt)
```
...
2. Chọn "Tìm lộ trình An toàn" (Safe Routing)
3. Đặt một điểm bắt đầu và điểm kết thúc trên bản đồ
4. Xem kết quả cảnh báo đoạn đường ngập và lộ trình vòng tránh tối ưu
...
- [API Documentation](./Services/README.md) – Danh sách API endpoints
...
- 🐛 Báo bug: [GitHub Issues](https://github.com/ASEAN-AI-DZ/AegisFlowAI/issues)
- 💬 Thảo luận: [GitHub Discussions](https://github.com/ASEAN-AI-DZ/AegisFlowAI/discussions)
...
© 2026 AegisFlow AI – Được phát triển với ❤️ bởi Nhóm ASEAN-AI-DZ# 🚀 