...
> Tất cả các dịch vụ mô-đun hóa tạo nên nền tảng AegisFlow AI
...
**Mục đích**: Phát hiện lũ lụt bằng AI qua hình ảnh/video

- 📸 Phân tích hình ảnh bằng Deep Learning (CNN, ResNet)
- 🌊 Ước lượng mực nước & độ sâu ngập
- 🔔 Cảnh báo lũ tự động theo thời gian thực
...
**Mục đích**: Quản lý & xử lý dữ liệu truyền thông

- 📹 Streaming camera giao thông (RTMP/HLS)
- 🖼️ Lưu trữ hình ảnh/video sự cố (bằng chứng)
- ⚙️ Tối ưu hóa & nén dữ liệu media
- ☁️ Tích hợp Cloud Storage (S3, GCS)
...
**Mục đích**: Hệ thống CityPoint khuyến khích cộng đồng

- 🪙 Tích lũy điểm thưởng khi báo cáo sự cố hữu ích
- 🎁 Đổi điểm lấy các dịch vụ đô thị hoặc quà tặng
- 📊 Theo dõi lịch sử đóng góp của công dân
- 🛡️ Đảm bảo tính minh bạch trong quản lý điểm thưởng
