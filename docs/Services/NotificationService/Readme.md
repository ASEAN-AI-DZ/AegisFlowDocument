...
**Notification & Emergency Response Service** của AegisFlow AI cung cấp:
...
---
_**AegisFlow AI – Cảnh báo kịp thời, bảo vệ cộng đồng.**_
...
Dự án này được phân phối dưới [GNU General Public License v3.0](https://github.com/ASEAN-AI-DZ/AegisFlow/blob/master/LICENSE).
